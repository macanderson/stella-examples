...
Since #3501 made `[oracle].command` optional beside a `[runtime]` block, that
argv appears **once** per manifest rather than twice, so the three files differ
in exactly one line each.
